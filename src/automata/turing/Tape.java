...
public class Tape implements Serializable {
	...
	public String saveOutput() {
	    String str1 = "outputs.txt";
	    String str2 = this.buffer.toString();
	    try{
	    	fileWriter= new FileWriter(str1);
	      fileWriter.write(str2);
	      System.out.print(this.buffer.toString());
	      System.out.println("File created and content written successfully.");
	    } catch (IOException iOException) {
	      System.err.println("An error occurred while writing the file: " + iOException.getMessage());
	    } 
	    return "saved";
	  }
	...
	public String getOutput() {
		...
		CurrentTape.globalTape=getContents();
		if (nextBlank == -1)
