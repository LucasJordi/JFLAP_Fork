...
import automata.turing.CurrentTape;
...
//						if(parsePane.stepAction.isEnabled()) model.setResult(r, "Accept", null, getEnvironment().myTransducerStrings, (r%uniqueInputs));
		...
		if(getObject() instanceof Automaton) {
			bar.add(new AbstractAction("Save Tape") {
			/**
				 * 
				 */
				private static final long serialVersionUID = 1L;
			...
			public void actionPerformed(ActionEvent e) {
				System.out.print(CurrentTape.globalTape);
				JTextArea textArea = new JTextArea(10, 30); // 10 rows, 30 columns
		        textArea.setText(CurrentTape.globalTape);
		        ...
		        String fileName = "tape_output_" + timestamp + ".txt";
		        String content = CurrentTape.globalTape;
		        try {
		        ...
		        // Create the JOptionPane with the scroll pane
		        int option = JOptionPane.showOptionDialog(
		            null,                 // Parent component
		            scrollPane,           // Component to display
		            "Generated Tape", // Dialog title
		            JOptionPane.OK_OPTION, // Option type
		            JOptionPane.PLAIN_MESSAGE, // Message type
		            null,                 // Icon (null means no icon)
		            new Object[] {},      // No custom buttons
		            null                  // Default button
		        );
		            // Write content to file
		        
		            
				////JOptionPane.showMessageDialog(null, CurrentTape.globalTape, "Message", JOptionPane.INFORMATION_MESSAGE);
